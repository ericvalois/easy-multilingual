...
class EML_Switcher {
	...
	static public function get_switcher_options($type = 'widget', $key ='string') {
		$options = array(
			'show_names'   => array('string' => __('Displays language names', 'easyMultilingual'), 'default' => 1),
			'show_flags'   => array('string' => __('Displays flags', 'easyMultilingual'), 'default' => 0),
			'force_home'   => array('string' => __('Forces link to front page', 'easyMultilingual'), 'default' => 0),
			'hide_current' => array('string' => __('Hides the current language', 'easyMultilingual'), 'default' => 0),
		);

		if ($type != 'menu')
			$options = array('dropdown' => array('string' => __('Displays as dropdown', 'easyMultilingual'), 'default' => 0)) + $options;
	 ...
	 * @see EML_Switcher::the_languages
	 *
	 * @since 1.2
	 *
	 * @param object $links instance of EML_Frontend_Links
	 * @param array $args
	 * @return array
	 */
 ...
 * @since 1.2
 */
class EML_Walker_List extends Walker {
