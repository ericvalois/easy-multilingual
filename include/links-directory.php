 ...
 * @since 1.2
 */
class EML_Links_Directory extends EML_Links_Model {
	 ...
	 * @since 1.2
	 *
	 * @param object $model EML_Model instance
	 */
	...
	public function prepare_rewrite_rules($pre) {
		//clean filters which could have been set in a previous call (may occur when changing EasyMultilingual settings)
	 ...
	 * thanks to brbrbr http://wordpress.org/support/topic/plugin-easyMultilingual-rewrite-rules-not-correct
	 *
	 * @since 0.8.1
	 *
