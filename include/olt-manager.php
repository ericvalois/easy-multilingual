 ...
 * so it is what EasyMultilingual intends to do
...
class EML_OLT_Manager {
	...
	public function __construct() {
		...
		add_filter('pre_update_option_active_sitewide_plugins', array(&$this, 'make_easyMultilingual_first'));
	}
	 ...
	 */
	public function make_easyMultilingual_first($plugins) {
		if ($key = array_search(EASYMULTILINGUAL_BASENAME, $plugins)) {
			unset($plugins[$key]);
			array_unshift($plugins, EASYMULTILINGUAL_BASENAME);
		}
		return $plugins;
	}
}
