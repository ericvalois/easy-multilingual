 ...
 * @since 1.2
 */
class EML_Frontend_Filters_Search {
	public $links;
	...
	public function __construct(&$easyMultilingual) {
		...
		if (!$this->using_permalinks && (!defined('EML_SEARCH_FORM_JS') || EML_SEARCH_FORM_JS))
	...
	public function wp_print_footer_scripts() {
		...
		// http://wordpress.org/support/topic/development-of-easyMultilingual-version-08?replies=6#post-2645559
