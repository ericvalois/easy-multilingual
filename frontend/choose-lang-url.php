 ...
 * @since 1.2
 */
class EML_Choose_Lang_Url extends EML_Choose_lang {
	...
	public function set_language_from_url() {
		...
		// http://wordpress.org/support/topic/plugin-easyMultilingual-language-homepage-redirection-problem-and-solution-but-incomplete?replies=4#post-2729566
