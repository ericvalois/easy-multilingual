	...
	function init_translations() {
		$('.tr_lang').each(function(){
			...
			$(this).autocomplete({
				...
				source: ajaxurl + '?action=eml_terms_not_translated&term_language=' + $('#term_lang_choice').val() +
					'&term_id=' + $("input[name='tag_ID']").val() + '&taxonomy=' + $("input[name='taxonomy']").val() +
					'&translation_language=' + tr_lang + '&post_type=' + typenow + '&_eml_nonce=' + $('#_eml_nonce').val(),
