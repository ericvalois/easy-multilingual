...
/*
 * extends the EML_Model class with methods needed only in EasyMultilingual settings pages
 *
 * @since 1.2
 */
class EML_Admin_Model extends EML_Model {
	...
	public function delete_language($lang_id) {
		...
		$post = get_page_by_title('easyMultilingual_mo_' . $lang->term_id, OBJECT, 'easyMultilingual_mo');
		if (!empty($post))
	 ...
	 * @return bool true if success / false if failed
	 * @see EML_Admin_Model::add_language
	 */
