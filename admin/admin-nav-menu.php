...
class EML_Admin_Nav_Menu {
	...
	public function __construct(&$easyMultilingual) {
		...
		add_action('admin_init', array(&$this, 'admin_init')); // after EasyMultilingual upgrade
				...
				<ul id ="lang-switch-checklist" class="categorychecklist form-no-clear">
					<li>
						<label class="menu-item-title">
							<input type="checkbox" class="menu-item-checkbox" name="menu-item[<?php echo $_nav_menu_placeholder; ?>][menu-item-object-id]" value="-1"> <?php _e('Language switcher', 'easyMultilingual'); ?>
						</label>
	...
	public function admin_enqueue_scripts() {
		...
		$data['strings'][] = __('Language switcher', 'easyMultilingual'); // the title
