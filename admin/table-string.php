 ...
 * @since 0.6
 */
class EML_Table_String extends WP_List_Table {
	protected $groups;
	...
	function get_columns() {
		return array(
			...
			'context'      => __('Group', 'easyMultilingual'),
			'name'         => __('Name', 'easyMultilingual'),
			'string'       => __('String', 'easyMultilingual'),
			'translations' => __('Translations', 'easyMultilingual'),
		);
	}
	...
	function prepare_items($data = array()) {
		$per_page = $this->get_items_per_page('eml_strings_per_page');
	...
	function get_bulk_actions() {
		return array('delete' => __('Delete','easyMultilingual'));
	}
	...
	function extra_tablenav($which) {
		...
		printf(
			...
			__('View all groups', 'easyMultilingual')
		);
