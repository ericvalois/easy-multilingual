...
EasyMultilingual adds multilingual content management support to WordPress.

== Description ==

= Features  =

EasyMultilingual allows you to create a bilingual or multilingual WordPress site. You write posts, pages and create categories and post tags as usual, and then define the language for each of them. The translation of a post, whether it is in the default language or not, is optional. The translation has to be done by the site editor as EasyMultilingual does not integrate any automatic or professional translation service.
...
Most of the flags included with EasyMultilingual are coming from [famfamfam](http://famfamfam.com/) and are public domain. Icons are coming from [Icomoon](http://icomoon.io/) and are licensed under GPL. Wherever third party code has been used, credit has been given in the code’s comments.

= Do you like EasyMultilingual? =

Don't hesitate to [give your feedback](http://wordpress.org/support/view/plugin-reviews/easyMultilingual#postform). It will help making the plugin better. Other [contributions](http://easyMultilingual.wordpress.com/documentation/contribute/) (such as new translations or helping other users on the support forum) are welcome !
...
1. If you tried other multilingual plugins, deactivate them before activating EasyMultilingual, otherwise, you may get unexpected results !
...
1. Take care that your theme must come with the corresponding .mo files (EasyMultilingual downloads them for themes bundled with WordPress). If your theme is not internationalized yet, please refer to the [codex](http://codex.wordpress.org/I18n_for_WordPress_Developers#I18n_for_theme_and_plugin_developers) or ask the theme author to internationalize it.

== Frequently Asked Questions ==

= Where to find help ? =

* Read the [documentation](http://easyMultilingual.wordpress.com/documentation/). It includes [guidelines to start working with EasyMultilingual](http://easyMultilingual.wordpress.com/documentation/setting-up-a-wordpress-multilingual-site-with-easyMultilingual/), a [FAQ](http://easyMultilingual.wordpress.com/documentation/frequently-asked-questions/) and the [documentation for programmers](http://easyMultilingual.wordpress.com/documentation/documentation-for-developers/).
* Search the [support forum](http://wordpress.org/support/plugin/easyMultilingual). I know that searching in the WordPress forum is not very convenient, but please give it a try. You can use generic search engines such as Google too as the WordPress forum SEO is very good. You will most probably find your answer here.
* If you still have a problem, open a new thread in the [support forum](http://wordpress.org/support/plugin/easyMultilingual).

= How to contribute? =

See http://easyMultilingual.wordpress.com/documentation/contribute/

== Screenshots ==

1. The EasyMultilingual languages admin panel in WordPress 3.8

== Upgrade Notice ==

= 1.5.4 =
EasyMultilingual 1.2 introduced major internal changes. More than ever, make a database backup before upgrading from 1.1.6 or older! If you are using a version older than 0.8, please ugrade to 0.9.8 before ugrading to 1.5.4
...
* Add: Possibility not to cache languages objects with option EML_CACHE_LANGUAGES (for GoDaddy users)
...
* Fix: EasyMultilingual does not play nice with switch_to_blog
